...
public class LoginUI extends JFrame implements ActionListener,MouseListener,FocusListener{
	...
	//重写按钮
		public void buttonSet(JButton button) {
			...
			button.setFocusPainted(false);//没有焦点
			//button.setBorderPainted(false);//按钮去边框
			//button.setBackground(Color.green);//按钮设置背景色
		}
	...
	public LoginUI() {
		...
		loginButton.addActionListener(this);//监听
		...
		registerButton.addActionListener(this);//监听
